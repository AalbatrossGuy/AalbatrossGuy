...
I am 19 years old and am interested in making my career in software development and Cloud Computing. I have been programming since I was 13 and have learnt quite a few languages and tech stacks over the years and I'm proficient in most of them. I code because computer and programming are my first love and I have no intention of dropping it anytime. Currently working with a legal tech startup. If my contribution graph is empty, it doesn't mean I'm slacking off, it just means that I'm contributing to private repos 😌

→ I'm based in Asia. <br>
→ Freelancing since 2021. <br>
→ I'm currently working on [termcapture](https://github.com/AalbatrossGuy/termcapture) - a terminal scrollable screenshot tool and [crunchy-to-mal](https://github.com/AalbatrossGuy/crunchy-to-mal) - a      script that scrapes your Crunchyroll watchlists, history, crunchylists and adds them to your MyAnimeList <br>
...
→ Checkout my [server config file](https://github.com/AalbatrossGuy/VargoMialo). <br>
